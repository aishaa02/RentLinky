...
const Host = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-[#ededed]">
      {/* Left Side: Video */}
      <div className="w-full md:w-1/2 flex justify-center items-center p-6">
        <video
          src="https://media.istockphoto.com/id/1792916494/video/isometric-view-of-kitchen-and-dining-room-with-fridge-3d-isometric-loop.mp4?s=mp4-480x480-is&k=20&c=bh7SXhhjT1Rpzc2I9i1ieeJL0KmOIXaL66O1xofz8sE="
      ...
      {/* Right Side: Host Options */}
      <div className="w-full md:w-1/2 flex flex-col items-center p-6">
        <h1 className="text-3xl font-semibold mb-8 text-[#222]">
      ...
      />
          ...
          >
            <div className="w-32 h-32 flex justify-center items-center bg-gray-100 rounded-lg mb-4">
            <img
        src={apartment} // Replace with your actual image path
        alt="Apartment Icon"
        className="w-24 h-24 object-contain"
      />
            </div>
